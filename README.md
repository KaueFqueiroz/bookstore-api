...
1. Acesse [bookstore-api-production-5798.up.railway.app](https://bookstore-api-production-5798.up.railway.app)
2. Use o Postman ou Insomnia
3. Registre um usuário: `POST /auth/registrar`
4. Faça login: `POST /auth/login`
5. Use o token retornado no header `Authorization: Bearer {token}`
6. Explore os endpoints listados abaixo
